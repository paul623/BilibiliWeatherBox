...
const char* WIFI_SSID = "JustDoIt";  //填写你的WIFI名称及密码
...
const char* HEFENG_LOCATION = "CN101190901";//填写你的城市ID,可到https://where.heweather.com/index.html查询
...
#if defined(ESP8266)
const int SDA_PIN = 0;  //引脚连接（GPIO0 对应D0 板子D4）
const int SDC_PIN = 2;  //板子D3
#endif
...
void webconnect() {  ////Web配网，密码直连将其注释
  ...
  wifiManager.setPageTitle("欢迎来到巴塞罗那的余晖的WiFi配置页");  //设置页标题
